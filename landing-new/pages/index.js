      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.solutionContainer}>
          <div
            ...
            <h1
              ...
              Your data is being used and exploited<br />every day.
            </h1>
        ...
        <div className={styles.cardsContainer}>
          <div className={styles.card}>
            <CharacteristicsCard option={'privacy-first'} />
          </div>
          <div className={styles.card}>
            <CharacteristicsCard option={'data-wallet'} />
          </div>
          <div className={styles.card}>
            <CharacteristicsCard option={'privacy-pipelines'} />
          </div>
        </div>
